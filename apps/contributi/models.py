...
class Campagna(FSMModelMixin, models.Model):
    ...
    def riapri(self) -> None:
        """Corpo intenzionalmente vuoto: la pulizia delle simulazioni stale
        vive nel service layer (`apps/contributi/campagne.py::riapri_campagna`),
        non qui — stesso schema delle altre transizioni (issue #18)."""
